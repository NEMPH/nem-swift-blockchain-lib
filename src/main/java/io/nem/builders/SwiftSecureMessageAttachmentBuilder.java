...
/**
 * The Class SwiftSecureMessageAttachmentBuilder.
 */
public class SwiftSecureMessageAttachmentBuilder {
	
	/**
	 * Instantiates a new swift secure message attachment builder.
	 */
	public SwiftSecureMessageAttachmentBuilder() {
	}
	...
	public static IMessage message(SecureMessage message) {
		return new SwiftSecureMessageAttachmentBuilder.Builder(message);
	}
	...
	public static class Builder implements IMessage, IBuild {
		...
		/* (non-Javadoc)
		 * @see io.nem.builders.SwiftSecureMessageAttachmentBuilder.IBuild#addMosaic(org.nem.core.model.mosaic.Mosaic)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see io.nem.builders.SwiftSecureMessageAttachmentBuilder.IBuild#addMosaic(org.nem.core.model.mosaic.MosaicId, org.nem.core.model.primitive.Quantity)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see io.nem.builders.SwiftSecureMessageAttachmentBuilder.IBuild#buildMessage()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see io.nem.builders.SwiftSecureMessageAttachmentBuilder.IMessage#message(org.nem.core.messages.SecureMessage)
		 */
		@Override
